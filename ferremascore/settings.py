...
X_FRAME_OPTIONS = 'ALLOW-FROM https://www.sandbox.paypal.com'
# Quick-start development settings - unsuitable for production
# See https://docs.djangoproject.com/en/5.0/howto/deployment/checklist/

# SECURITY WARNING: keep the secret key used in production secret!
SECRET_KEY = 'django-insecure-ee9#on@zpsqv663t8%%o%^(yhll-mhy43#mxjwd%l6o5g-(s_q'
...
ROOT_URLCONF = 'ferremascore.urls'
...
TEMPLATES = [
    {
        ...
        'DIRS': [
            ...
            os.path.join(BASE_DIR, 'src/views/shoppingCart'),
            os.path.join(BASE_DIR, 'src/views/register'),
...
WSGI_APPLICATION = 'ferremascore.wsgi.application'
